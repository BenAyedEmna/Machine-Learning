...
# Charger MobileNetV2 pré-entraîné sur ImageNet sans la couche fully-connected (include_top=False)
base_model = MobileNetV2(weights='imagenet', include_top=False, input_shape=(img_width, img_height, 3))

# Ajouter des couches personnalisées pour la classification binaire (avec masque ou sans masque)
x = base_model.output
x = Flatten()(x)
...
checkpoint = ModelCheckpoint("modelMobileNetV2.h5", monitor='val_accuracy', verbose=1, save_best_only=True, save_weights_only=False, mode='auto')
